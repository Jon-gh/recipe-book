...
const mockRecipe = {
  ...
  ingredients: [
    { id: 1, productId: 1, quantity: 400, unit: "g", preparation: "", recipeId: "recipe-1", product: { id: 1, name: "Pasta", category: "grains & pulses", defaultUnit: "g", defaultQuantity: 500, source: "system" } },
    { id: 2, productId: 2, quantity: 4, unit: "", preparation: "beaten", recipeId: "recipe-1", product: { id: 2, name: "Eggs", category: "dairy & eggs", defaultUnit: "", defaultQuantity: 1, source: "system" } },
  ],
};
